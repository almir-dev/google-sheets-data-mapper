...
import {getOneToOneColumn} from "../Dto";
...
class OneToOneEntityServiceImpl {
    ...
    private getOneToOneEntities(oneToOneProps: OneToOneProps) {
        ...
        const referenceEntityName = OneToOneEntityServiceImpl.getReferenceEntityNameFromProperty(targetClassObject, propertyName);
